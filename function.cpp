...
void menu() // вывод меню
{
	...
	cout << "3. —ортировать массив с помощью двунаправленного алгоритма выбора (selection sort)" << endl;
	cout << "4. ¬ывести массив на экран" << endl;
...
void print(vector<int>& mas, unsigned int search_time) // выворд массива и времени 
{
	...
	cout << endl << "затраченое врем€: " << search_time << " мсек." << endl;
}
